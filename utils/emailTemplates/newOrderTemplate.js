    ...
    ">
      ...
      ">
        ...
        <div style="text-align: center; margin-bottom: 24px;">
          <h2 style="margin: 0; font-size: 22px;">🛍️ Order Confirmation</h2>
          <p style="margin-top: 8px; color: #6b7280; font-size: 15px;">
            Thank you for your order! We're processing it and will update you soon.
          </p>
        </div>
        ...
        <!-- Items Table -->
        <h3 style="font-size: 17px; margin-bottom: 10px;">🧾 Items Ordered</h3>
        <table width="100%" cellspacing="0" cellpadding="0" style="
          border-collapse: collapse;
          border: 1px solid #e5e7eb;
          border-radius: 10px;
        ...
        <div style="text-align: center; margin-top: 32px;">
          <p style="margin-top: 16px; color: #6b7280; font-size: 13px;">
            You’ll receive another update once your order is shipped.<br />
            Thank you for choosing <strong>Dloklz</strong> 💛
          </p>
        </div>
      </div>
